...
function getAllForums() {
    ...
    if (location.hostname === "localhost" || location.hostname === "127.0.0.1") {
        xhr.open('GET', 'http://localhost:5001/webapp0-17967/us-central1/getAllForums');
    } else {
        xhr.open('GET', 'https://us-central1-webapp0-17967.cloudfunctions.net/getAllForums');
    }
            ...
            if (xhr.status === OK) {
                ...
                if (!found) { //if the entered code is not in existing modules
                    ...
                    if (theAnswer) {
                        ...
                        window.location.href = "https://webapp0-17967.web.app/createForum.html";
                    }
                } else {
                    verifyAlreadyMember();
                }
